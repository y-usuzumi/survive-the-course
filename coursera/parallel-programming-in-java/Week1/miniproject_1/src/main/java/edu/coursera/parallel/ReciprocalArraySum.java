...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            ...
            for (int chunk = 0; chunk < numOfTasks; chunk++) {
                final int startIndexInclusive = this.startIndexInclusive + getChunkStartInclusive(chunk, numOfTasks, size);
                final int endIndexExclusive = this.startIndexInclusive + getChunkEndExclusive(chunk, numOfTasks, size);
                tasks[chunk] = new ReciprocalArraySumTask(startIndexInclusive, endIndexExclusive, input, numOfTasks);
                tasks[chunk].fork();
            }
